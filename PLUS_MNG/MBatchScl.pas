...
// Raize
  RzPanel, RzEdit, RzDBEdit, kcRaizeCtrl, RzCmboBx, RzDBCmbo, RzSplit, RzLstBox,
  RzDBNav, VCL_Helper,
// EhLib
...
procedure TfmBatchScl.FormCreate(Sender: TObject);
begin
  inherited;
  SetADOConn(fmBatchScl);
end;
