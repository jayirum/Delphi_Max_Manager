inherited fmTodayPL: TfmTodayPL
  ...
  inherited pnTop: TRzPanel
    ...
    object bsSkinStdLabel3: TbsSkinStdLabel [10]
      ...
      SkinDataName = 'stdlabel'
      AutoSize = False
      Caption = '( 12:00:07 '#51312#54924#46120')'
    end
    ...
    object cbxAuto: TbsSkinCheckRadioBox
      Left = 601
      Top = 6
      Width = 72
      Height = 20
    ...
    object cbInterval: TkcRzComboBox
      Left = 518
      Top = 7
      Width = 82
      Height = 20
  ...
  inherited pnBottom: TbsSkinPanel
    ...
    object cbxPosQty: TbsSkinCheckRadioBox
      ...
      GroupIndex = 0
      Caption = #49688#47049
      OnClick = cbxPosQtyClick
    end
    object cbxAvgPrc: TbsSkinCheckRadioBox
      Left = 97
      Top = 0
      Width = 79
      Height = 23
      ...
      OnClick = cbxAvgPrcClick
    end
    object cbxClrPL: TbsSkinCheckRadioBox
      Left = 177
      Top = 0
      Width = 79
      Height = 23
      ...
      OnClick = cbxClrPLClick
    end
    object cbxCmsn: TbsSkinCheckRadioBox
      Left = 257
      Top = 0
      Width = 79
      Height = 23
      ...
      OnClick = cbxCmsnClick
    end
    object cbxEvaPL: TbsSkinCheckRadioBox
      Left = 337
      Top = -1
      Width = 79
      Height = 24
  ...
  object gdMain: TDBGridEh [2]
    ...
    Columns = <
      ...
      item
        ...
        Footer.Alignment = taRightJustify
        Footer.FieldName = 'HSI_AVG_PRC'
        Footers = <>
        Title.Caption = #54637#49373#51648#49688'|'#54217#44512#45800#44032
        Width = 65
      end
      item
        Alignment = taRightJustify
  ...
  inherited imgBtn: TImageList
    ...
    Top = 288
    Bitmap = {
      494C01010B003400F40010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object tmAutoSearch: TThreadedTimer
    OnTimer = tmAutoSearchTimer
    Left = 588
    Top = 12
  end
end
