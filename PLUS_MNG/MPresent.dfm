inherited fmPresent: TfmPresent
  ...
  inherited pnTop: TRzPanel
    ...
    object cbxAuto: TRzCheckBox
      ...
      Transparent = True
      WordWrap = True
      OnClick = cbxAutoClick
    end
    object cbStk: TRzCheckBox
      Left = 394
      Top = 8
      Width = 79
      Height = 15
  ...
  object pnMain: TRzPanel [2]
    ...
    object RzGroupBox2: TRzGroupBox
      ...
      object gdNclrListR: TDBGridEh
        ...
        TitleParams.RowHeight = 21
        TitleParams.FillStyle = cfstGradientEh
        OnDrawColumnCell = gdNclrListRDrawColumnCell
        Columns = <
          item
            Alignment = taCenter
            DynProps = <>
    ...
    object RzGroupBox3: TRzGroupBox
      ...
      object gdMitR: TDBGridEh
        ...
        TitleParams.RowHeight = 21
        TitleParams.FillStyle = cfstGradientEh
        OnDrawColumnCell = gdMitRDrawColumnCell
        Columns = <
          item
            Alignment = taCenter
            DynProps = <>
