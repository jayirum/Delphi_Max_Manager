...
//  Mask, math, Messages, Variants, Graphics,
// BusinessSkinForm_1042
  BusinessSkinForm, bsSkinCtrls, bsRibbon, bsMessages,
// Raize, kcRaize
  RzPanel, RzEdit, RzCmboBx, RzDBCmbo, RzSplit, RzLstBox, RzDBEdit, RzDBNav, kcRaizeCtrl, VCL_Helper,
// EhLib
...
procedure TfmOverNgt.FormCreate(Sender: TObject);
begin
  inherited;
  SetADOConn(fmOverNgt);
end;

procedure TfmOverNgt.FormShow(Sender: TObject);
begin
  inherited;
