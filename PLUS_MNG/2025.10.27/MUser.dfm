inherited fmUser: TfmUser
  ...
  object gdMain: TDBGridEh [4]
    ...
    Columns = <
      ...
      item
        ...
        Footers = <>
        Title.Alignment = taCenter
        Title.Caption = #48372#50504#48264#54840
        Title.Color = 16250871
        Width = 101
      end
      item
        ...
        Footers = <>
        Title.Caption = #48660#47001#50976#51200
        Visible = False
        Width = 101
      end
      item
        ...
        FieldName = 'USER_BANK'
        Footers = <>
        Title.Caption = #44256#44061#51008#54665
        Visible = False
      end
      item
        DynProps = <>
        ...
        FieldName = 'MNG_USER'
        Footers = <>
        Title.Caption = #44288#47532#44256#44061
        Visible = False
      end>
  ...
  object pgMain: TbsSkinPageControl [5]
    ...
    object bsSkinTabSheet1: TbsSkinTabSheet
      ...
      object RzPanel4: TRzPanel
        ...
        FlatColorAdjustment = 0
        TabOrder = 0
        object btnPass: TbsSkinSpeedButton
          Tag = 300
          Left = 415
          Top = 135
          Width = 73
        ...
        object RzLabel1: TRzLabel
          ...
          Width = 425
          Height = 13
          Caption = #8251' '#51064#53552#45367#51060' '#48520#50504#51221#54620' '#54924#50896#46308#51012' '#44288#47532#54633#45768#45796'. ('#44288#47532#54016#50640#49436' '#51221#44592#51201#51004#47196' '#52404#53356#54644' '#46300#47549#45768#45796'.)'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clRed
          Font.Height = 13
          Font.Name = 'Tahoma'
        ...
        object bsSkinLabel49: TbsSkinLabel
          Left = 254
          Top = 161
          Width = 80
          Height = 20
          ...
          BorderStyle = bvFrame
          Alignment = taCenter
          Caption = #48372#50504#48264#54840
          AutoSize = False
        end
    ...
    object bsSkinTabSheet2: TbsSkinTabSheet
      ...
      object RzPanel8: TRzPanel
        ...
        object cbxOverNgtYN: TkcRzDBComboBox
          Left = 91
          Top = 138
          Width = 151
          Height = 21
        ...
        object cbxLevApply: TRzCheckBox
          Left = 91
          Top = 244
          Width = 121
          Height = 15
    ...
    object bsSkinTabSheet4: TbsSkinTabSheet
      ...
      object RzPanel2: TRzPanel
        ...
        object RzGroupBox1: TRzGroupBox
          ...
          object btnInMsgClear: TbsSkinButton
            Tag = 200
            Left = 288
            Top = 76
            Width = 89
  ...
  object ScrollBar1: TScrollBar [6]
    Left = 683
    Top = 60
    Width = 17
    Height = 591
  ...
  inherited imgBtn: TImageList
    Bitmap = {
      494C01011600D001B40210001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  inherited dbMain: TADOQuery
    ...
    SQL.Strings = (
      ...
      '          ,A.USER_TEL          '
        ...
        '          ,CASE WHEN (SELECT COUNT(1) FROM CNTR WHERE USER_ID = ' +
        'A.USER_ID) > 0 THEN (SELECT CURR_TRADE_DT FROM CORP_MST) '
      
        '                ELSE (SELECT MAX(CNTR_DT) FROM CNTR_HIS WHERE US' +
        'ER_ID = A.USER_ID) '
      '            END LAST_CNTR_DT   '
      
        '          ,(SELECT MAX(LOGIN_DT) FROM LOGIN_HIS WHERE USER_ID = ' +
        'A.USER_ID AND LOGIN_TP = '#39'I'#39' AND APP_TP = '#39'C'#39') AS LOGIN_DT '
      '          ,A.SERVER_IP         '
      '          ,A.RECOMM_NM           '
      '          ,A.USER_PWD          '
      '          ,A.USER_BANK         '
      ...
      '          ,A.USER_BIGO         '
        ...
        '     FROM USER_MST A LEFT OUTER JOIN ACNT_MST B ON A.USER_ID = B' +
        '.USER_ID'
      ''
      ' ')
  end
  ...
  object popBlockIP: TbsSkinPopupMenu
    ...
    object popbtnInputMac: TMenuItem
      Caption = #48660#47085' '#47589#51452#49548' '#52628#44032
      OnClick = popbtnInputMacClick
    end
    object N4: TMenuItem
      Caption = '-'
    end
    object popbtnReleaseIP: TMenuItem
      Caption = #48660#47085'IP '#54644#51228
      OnClick = popbtnReleaseIPClick
    end
    object popbtnReleaseMac: TMenuItem
      Caption = #48660#47085' '#47589#51452#49548' '#54644#51228
      OnClick = popbtnReleaseMacClick
    end
    object N2: TMenuItem
      Caption = '-'
    end
    object popbtnCopyIP: TMenuItem
      Caption = 'IP '#48373#49324#54616#44592
      OnClick = popbtnCopyIPClick
    end
    object popbtnCopyMac: TMenuItem
      Caption = #47589#51452#49548' '#48373#49324#54616#44592
      OnClick = popbtnCopyMacClick
    end
    object N5: TMenuItem
      Caption = '-'
    end
    object popbtnExcel: TMenuItem
      Caption = #47196#44536#51064#45236#50669' '#50641#49472#51200#51109
      OnClick = popbtnExcelClick
    end
  end
  object dbTemp: TADOQuery
    CursorType = ctStatic
    LockType = ltBatchOptimistic
    AfterOpen = dbMainAfterOpen
    AfterInsert = dbMainAfterInsert
