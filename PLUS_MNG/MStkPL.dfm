inherited fmStkPL: TfmStkPL
  ...
  inherited dbMain: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT AA.TRADE_DT          ,CLR_PL_SUM           ,BB.CMSN      ' +
        '        ,NET_PL               ,ACNT_AMT_BF'
      
        '      ,ACNT_AMT_TODAY       ,RSLT_IN_AMT          ,RSLT_OUT_AMT ' +
        '        ,YET_OUT_AMT          ,KSF_PL'
      
        '      ,KSF_CMSN             ,KSO_PL_DAY           ,KSO_CMSN_DAY ' +
        '        ,KSO_PL_NGT           ,KSO_CMSN_NGT'
      
        '      ,URO_CLR_PL           ,URO_CMSN             ,CL_CLR_PL    ' +
        '        ,CL_CMSN              ,GC_CLR_PL'
      
        '      ,GC_CMSN              ,NG_CLR_PL            ,NG_CMSN      ' +
        '        ,ES_CLR_PL            ,ES_CMSN'
      
        '      ,AD_CLR_PL            ,AD_CMSN              ,BP_CLR_PL    ' +
        '        ,BP_CMSN              ,JY_CLR_PL'
      
        '      ,JY_CMSN              ,NQ_CLR_PL            ,NQ_CMSN      ' +
        '        ,YM_CLR_PL            ,YM_CMSN'
      
        '      ,SCN_CLR_PL           ,SCN_CMSN             ,HSI_CLR_PL   ' +
        '        ,HSI_CMSN             ,SSI_CLR_PL'
      
        '      ,SSI_CMSN             ,FDAX_CLR_PL          ,FDAX_CMSN    ' +
        '        ,CD_CLR_PL            ,CD_CMSN'
      
        '      ,SI_CLR_PL            ,SI_CMSN              ,HG_CLR_PL    ' +
        '        ,HG_CMSN'
      ' FROM (SELECT TRADE_DT'
      
        '             ,SUM(ACNT_AMT_BF   ) ACNT_AMT_BF                ,SU' +
        'M(ACNT_AMT_TODAY) ACNT_AMT_TODAY'
      
        '             ,SUM(CLR_PL_SUM    ) CLR_PL_SUM                 ,SU' +
        'M(RSLT_IN_AMT   ) RSLT_IN_AMT'
      
        '             ,SUM(RSLT_OUT_AMT  ) RSLT_OUT_AMT               ,SU' +
        'M(YET_OUT_AMT   ) YET_OUT_AMT'
      '        FROM (SELECT A1.* FROM ACNT_CLS A1, USER_MST B1'
      '       WHERE A1.USER_ID = B1.USER_ID    ) A'
      'WHERE TRADE_DT BETWEEN '#39'20251110'#39' AND '#39'20251117'#39
      'GROUP BY TRADE_DT) AA LEFT OUTER JOIN'
      '(SELECT TRADE_DT'
      '       ,SUM(CMSN  ) CMSN              ,SUM(NET_PL) NET_PL'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'101'#39' THEN CLR_PL END) KSF_PL'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'101'#39' THEN CMSN   END) KSF_CMSN'
      
        '       ,SUM(CASE WHEN ARTC_CD = '#39'201'#39' THEN CLR_PL END) KSO_PL_DA' +
        'Y'
      
        '       ,SUM(CASE WHEN ARTC_CD = '#39'201'#39' THEN CMSN   END) KSO_CMSN_' +
        'DAY'
      
        '       ,SUM(CASE WHEN ARTC_CD = '#39'301'#39' THEN CLR_PL END) KSO_PL_NG' +
        'T'
      
        '       ,SUM(CASE WHEN ARTC_CD = '#39'301'#39' THEN CMSN   END) KSO_CMSN_' +
        'NGT'
      
        '       ,SUM(CASE WHEN ARTC_CD = '#39'URO'#39' THEN CLR_PL END) URO_CLR_P' +
        'L'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'URO'#39' THEN CMSN   END) URO_CMSN'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'CL'#39' THEN CLR_PL END) CL_CLR_PL'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'CL'#39' THEN CMSN   END) CL_CMSN'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'GC'#39' THEN CLR_PL END) GC_CLR_PL'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'GC'#39' THEN CMSN   END) GC_CMSN'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'NG'#39' THEN CLR_PL END) NG_CLR_PL'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'NG'#39' THEN CMSN   END) NG_CMSN'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'ES'#39' THEN CLR_PL END) ES_CLR_PL'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'ES'#39' THEN CMSN   END) ES_CMSN'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'AD'#39' THEN CLR_PL END) AD_CLR_PL'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'AD'#39' THEN CMSN   END) AD_CMSN'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'BP'#39' THEN CLR_PL END) BP_CLR_PL'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'BP'#39' THEN CMSN   END) BP_CMSN'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'JY'#39' THEN CLR_PL END) JY_CLR_PL'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'JY'#39' THEN CMSN   END) JY_CMSN'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'NQ'#39' THEN CLR_PL END) NQ_CLR_PL'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'NQ'#39' THEN CMSN   END) NQ_CMSN'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'YM'#39' THEN CLR_PL END) YM_CLR_PL'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'YM'#39' THEN CMSN   END) YM_CMSN'
      
        '       ,SUM(CASE WHEN ARTC_CD = '#39'SCN'#39' THEN CLR_PL END) SCN_CLR_P' +
        'L'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'SCN'#39' THEN CMSN   END) SCN_CMSN'
      
        '       ,SUM(CASE WHEN ARTC_CD = '#39'HSI'#39' THEN CLR_PL END) HSI_CLR_P' +
        'L'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'HSI'#39' THEN CMSN   END) HSI_CMSN'
      
        '       ,SUM(CASE WHEN ARTC_CD = '#39'SSI'#39' THEN CLR_PL END) SSI_CLR_P' +
        'L'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'SSI'#39' THEN CMSN   END) SSI_CMSN'
      
        '       ,SUM(CASE WHEN ARTC_CD = '#39'FDAX'#39' THEN CLR_PL END) FDAX_CLR' +
        '_PL'
      
        '       ,SUM(CASE WHEN ARTC_CD = '#39'FDAX'#39' THEN CMSN   END) FDAX_CMS' +
        'N'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'CD'#39' THEN CLR_PL END) CD_CLR_PL'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'CD'#39' THEN CMSN   END) CD_CMSN'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'SI'#39' THEN CLR_PL END) SI_CLR_PL'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'SI'#39' THEN CMSN   END) SI_CMSN'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'HG'#39' THEN CLR_PL END) HG_CLR_PL'
      '       ,SUM(CASE WHEN ARTC_CD = '#39'HG'#39' THEN CMSN   END) HG_CMSN'
      
        'FROM (SELECT A1.* FROM ACNT_STK_CLS A1, USER_MST B1 WHERE A1.USE' +
        'R_ID = B1.USER_ID    ) A'
      'WHERE TRADE_DT BETWEEN '#39'20251110'#39' AND '#39'20251117'#39
      'GROUP BY TRADE_DT      ) BB ON AA.TRADE_DT = BB.TRADE_DT'
