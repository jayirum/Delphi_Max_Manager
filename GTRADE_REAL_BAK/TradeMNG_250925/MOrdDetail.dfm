inherited fmOrdDetail: TfmOrdDetail
  ...
  inherited pnTop: TRzPanel
    ...
    object chTogether: TbsSkinCheckRadioBox
      Left = 543
      Top = 2
      Width = 128
      Height = 25
  ...
  object RzPanel1: TRzPanel [3]
    ...
    object RzSizePanel1: TRzSizePanel
      ...
      object RzPanel4: TRzPanel
        ...
        object btnOrd: TbsSkinSpeedButton
          Tag = 500
          Left = 345
          Top = 4
          Width = 112
    ...
    object RzPanel3: TRzPanel
      ...
      object btnCntr: TbsSkinSpeedButton
        Tag = 500
        Left = 345
        Top = 4
        Width = 112
    ...
    object RzPanel7: TRzPanel
      ...
      object btnPartner: TbsSkinSpeedButton
        Tag = 500
        Left = 726
        Top = 3
        Width = 110
        ...
        Down = False
        GroupIndex = 0
        Caption = #51068#44292#54028#53944#45320#48320#44221
        ShowCaption = True
        NumGlyphs = 1
        Spacing = 1
        OnClick = btnPartnerClick
      end
      object btnOnePartner: TbsSkinSpeedButton
        Tag = 500
        Left = 839
        Top = 3
        Width = 122
        ...
        Down = False
        GroupIndex = 0
        Caption = #49440#53469#44148#54028#53944#45320#48320#44221
        ShowCaption = True
        NumGlyphs = 1
        Spacing = 1
        OnClick = btnOnePartnerClick
      end
  ...
  inherited imgBtn: TImageList
    Bitmap = {
      494C01010B00EC00580110001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  inherited dbMain: TUniQuery
    ...
    object dbMainACNT_TP2: TStringField
      FieldName = 'ACNT_TP'
      FixedChar = True
      Size = 1
    end
    ...
    object dbMainBS_TP2: TStringField
      FieldName = 'BS_TP'
      FixedChar = True
      Size = 1
    end
    ...
    object dbMainCLR_TP2: TStringField
      FieldName = 'CLR_TP'
      FixedChar = True
      Size = 1
    end
    ...
    object dbMainAPI_TP2: TStringField
      FieldName = 'API_TP'
      FixedChar = True
      Size = 1
    end
    ...
    object dbMainLEVERAGE: TIntegerField
      FieldName = 'LEVERAGE'
    end
  end
