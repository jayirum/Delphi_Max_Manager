inherited fmTodayPL: TfmTodayPL
  Tag = 2007
  Caption = #44552#51068' '#49552#51061#54788#54889
  ClientWidth = 1186
  ...
  inherited pnTop: TRzPanel
    ...
    object chTrade: TbsSkinCheckBox
      Left = 836
      Top = 4
      Width = 90
      Height = 22
      ...
      Checked = False
      GroupIndex = 0
      Caption = #44144#47000#54924#50896#47564
    end
  end
  inherited pnBottom: TbsSkinPanel
    ...
    object chOp: TbsSkinCheckBox
      ...
      Checked = False
      GroupIndex = 0
      Caption = #50741#49496'('#50556')'
      OnClick = chOpClick
    end
    object chURO: TbsSkinCheckBox
      Left = 241
      Top = 1
      Width = 85
      Height = 22
    ...
    object chAD: TbsSkinCheckBox
      ...
      Checked = False
      GroupIndex = 0
      Caption = #54840#51452#45804#47084
      OnClick = chADClick
    end
    object chBP: TbsSkinCheckBox
      Left = 671
      Top = 1
      Width = 85
      Height = 22
      ...
      Checked = False
      GroupIndex = 0
      Caption = 'B'#54028#50868#46300
      OnClick = chBPClick
    end
    object chJY: TbsSkinCheckBox
      Left = 757
      Top = 1
      Width = 85
      Height = 22
    ...
    object chSCN: TbsSkinCheckBox
      ...
      Checked = False
      GroupIndex = 0
      Caption = #51473#44397'A50'
      OnClick = chSCNClick
    end
    object chHSI: TbsSkinCheckBox
      Left = 327
      Top = 22
      Width = 85
      Height = 22
    ...
    object chNightF: TbsSkinCheckBox
      Left = 164
      Top = 1
      Width = 75
      Height = 22
      ...
      OnClick = chNightFClick
    end
    object chDayOp: TbsSkinCheckBox
      Left = 88
      Top = 1
      Width = 75
      Height = 22
      ...
      Checked = False
      GroupIndex = 0
      Caption = #44397#50741'('#51452')'
      OnClick = chDayOpClick
    end
    object chDayF: TbsSkinCheckBox
      Left = 12
      Top = 1
      Width = 75
      Height = 22
  ...
  object gdMain: TDBGridEh [2]
    ...
    Columns = <
      item
        ...
        Width = 90
        OnAdvDrawDataCell = gdMainColumns0AdvDrawDataCell
      end
      item
        Alignment = taCenter
        Color = clWhite
      ...
      item
        ...
        Width = 90
        OnAdvDrawDataCell = gdMainColumns19AdvDrawDataCell
      end
      item
        Color = clWhite
        DynProps = <>
      ...
      item
        ...
        Title.Caption = #44397#45236#50741#49496' ('#51452#44036')|'#49688#47049
        Width = 40
        OnAdvDrawDataCell = gdMainColumns19AdvDrawDataCell
      end
      item
        ...
        Footers = <>
        Title.Caption = #44397#45236#50741#49496' ('#51452#44036')|'#54217#44512#45800#44032
        Width = 60
      end
      item
        Alignment = taRightJustify
      ...
      item
        ...
        Title.Caption = #44397#45236#50741#49496' ('#51452#44036')|'#54217#44032#49552#51061
        Width = 70
        OnAdvDrawDataCell = gdMainColumns19AdvDrawDataCell
      end
      item
      ...
      item
        ...
        DynProps = <>
        EditButtons = <>
        FieldName = 'YM_AVG_PRC'
        Footers = <>
        Title.Caption = #45796#50864#51648#49688'|'#54217#44512#45800#44032
        Width = 60
      end
      item
        Alignment = taRightJustify
      ...
      item
        ...
        DynProps = <>
        EditButtons = <>
        FieldName = 'SCN_AVG_PRC'
        Footers = <>
        Title.Caption = #51473#44397' A 50|'#54217#44512#45800#44032
        Width = 60
      end
      item
        Alignment = taRightJustify
      ...
      item
        ...
        Title.Caption = #54637#49485#51648#49688'|'#49688#47049
        Width = 40
        OnAdvDrawDataCell = gdMainColumns19AdvDrawDataCell
      end
      item
        ...
        DynProps = <>
        EditButtons = <>
        FieldName = 'HSI_AVG_PRC'
        Footer.Alignment = taRightJustify
        Footers = <>
        Title.Caption = #54637#49485#51648#49688'|'#54217#44512#45800#44032
        Width = 60
      end
      item
        Alignment = taRightJustify
        ...
        Title.Caption = #54637#49485#51648#49688'|'#49892#54788#49552#51061
        Width = 70
        OnAdvDrawDataCell = gdMainColumns19AdvDrawDataCell
      end
      item
        ...
        Title.Caption = #54637#49485#51648#49688'|'#49688#49688#47308
        Width = 70
      end
      item
        Alignment = taRightJustify
        ...
        Title.Caption = #54637#49485#51648#49688'|'#54217#44032#49552#51061
        Width = 70
        OnAdvDrawDataCell = gdMainColumns19AdvDrawDataCell
      end
      item
      ...
      item
        DynProps = <>
        EditButtons = <>
        FieldName = 'CD_AVG_PRC'
        Footers = <>
        Title.Caption = #52880#45208#45796#45804#47084'|'#54217#44512#45800#44032
        Width = 60
      end
      item
        DynProps = <>
      ...
      item
        DynProps = <>
        EditButtons = <>
        FieldName = 'SI_AVG_PRC'
        Footers = <>
        Title.Caption = #49892#48260'|'#54217#44512#45800#44032
        Width = 60
      end
      item
        DynProps = <>
  ...
  object bsSkinPanel1: TbsSkinPanel [3]
    Left = 0
    Top = 483
    Width = 1186
    Height = 25
    ...
    Spacing = 2
    Align = alBottom
    object chPos_Qty: TbsSkinCheckBox
      Left = 12
      Top = 1
      Width = 75
      Height = 22
      ...
      GroupIndex = 0
      Caption = #49688#47049
      OnClick = chPos_QtyClick
    end
    object chClr_PL: TbsSkinCheckBox
      Left = 165
      Top = 1
      Width = 75
      Height = 22
      ...
      OnClick = chClr_PLClick
    end
    object chCmsn: TbsSkinCheckBox
      Left = 241
      Top = 1
      Width = 85
      Height = 22
    ...
    object chAvg_Prc: TbsSkinCheckBox
      Left = 88
      Top = 1
      Width = 75
      Height = 22
      ...
      OnClick = chAvg_PrcClick
    end
    object chEva_PL: TbsSkinCheckBox
      Left = 327
      Top = 1
      Width = 85
      Height = 22
  ...
  inherited imgBtn: TImageList
    ...
    Top = 336
    Bitmap = {
      494C01010B006000940010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
