...
uses
  ...
  MOverNgt_Req in 'MOverNgt_Req.pas' {fmOverNgt_Req},
  MOverNgt in 'MOverNgt.pas' {fmOverNgt},
  MOverNgtList in 'MOverNgtList.pas' {fmOverNgtList},
  MUserOverNgt in 'MUserOverNgt.pas' {fmUserOverNgt},
  MIPList in 'MIPList.pas' {fmIPList},
  MNego_Artc in 'MNego_Artc.pas' {fmNego_Artc},
  MUserNegoARTC in 'MUserNegoARTC.pas' {fmUserNegoARTC},
  MLossCut in 'MLossCut.pas' {fmLossCut},
  MMNG_Notice in 'MMNG_Notice.pas' {fmMNG_Notice};
...
//  Application.MainFormOnTaskbar := True;
  Application.Title := 'ProPlus °ü¸®ÀÚ';
