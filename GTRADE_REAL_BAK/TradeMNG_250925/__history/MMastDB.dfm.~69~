object MastDB: TMastDB
  ...
  object UniConnection: TUniConnection
    ...
    Username = 'sa'
    Server = '112.175.88.44'
    ConnectDialog = UniConnectDialog
    LoginPrompt = False
    AfterDisconnect = UniConnectionAfterDisconnect
    Left = 48
    Top = 136
    EncryptedPassword = '98FFD2FF8BFF8DFF9EFF9BFF9AFFCDFFCFFFCEFFCBFFDEFFDEFFBFFFBFFF'
  end
  ...
  object tmRetry: TThreadedTimer
    Interval = 30000
    OnTimer = tmRetryTimer
    Left = 472
    Top = 248
  end
  object AccessUniProvider: TAccessUniProvider
    Left = 480
    Top = 376
  end
end
