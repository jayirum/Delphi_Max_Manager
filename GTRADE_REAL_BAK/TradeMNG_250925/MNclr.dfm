inherited fmNclr: TfmNclr
  Tag = 3001
  Caption = #48120#52397#49328#51092#44256#45236#50669
  KeyPreview = False
  OnShow = FormShow
  PixelsPerInch = 96
  TextHeight = 12
  ...
  object RzPanel1: TRzPanel [2]
    ...
    object RzPanel2: TRzPanel
      ...
      object btnOK: TbsSkinSpeedButton
        ...
        Down = False
        GroupIndex = 0
        Caption = #54252#51648#49496' '#52397#49328
        ShowCaption = True
        NumGlyphs = 1
        Spacing = 1
        OnClick = btnOKClick
      ...
      object bsSkinLabel3: TbsSkinLabel
        ...
        BorderStyle = bvFrame
        Alignment = taCenter
        Caption = #54252#51648#49496#51221#48372
        AutoSize = False
      end
      ...
      object kcRzDBEdit5: TkcRzDBEdit
        Left = 176
        Top = 39
        Width = 116
        Height = 20
      ...
      object bsSkinLabel4: TbsSkinLabel
        ...
        BorderStyle = bvFrame
        Alignment = taCenter
        Caption = #52397#49328#44032#44396#48516
        AutoSize = False
      end
  ...
  inherited imgBtn: TImageList
    Bitmap = {
      494C01010B007C00940010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  inherited dbMain: TUniQuery
    SQL.Strings = (
      'SELECT A.ACNT_NO+A.STK_CD AS NCLR_KEY,'
      '                          B.USER_NM,'
      '                          B.USER_ID,'
      '                          A.ACNT_NO,'
      '                          B.ACNT_PWD,'
      ...
      '                          A.BS_TP,'
        ...
        '                          CASE WHEN A.BS_TP = '#39'S'#39' THEN '#39#47588#46020#39' ELSE' +
        ' '#39#47588#49688#39' END AS BS_NM,'
      '                          A.NCLR_POS_QTY,'
      '                          A.AVG_PRC,'
      '                          A.NCNTR_QTY,'
      '                          A.TRADE_DT,'
      ...
      '                          A.OVERNGT_AMT,'
        ...
        '                          (B.ACNT_AMT + B.CLR_PL - B.CMSN) AS AC' +
        'NT_AMT,'
      
        '                          (SELECT OVERNGT_YN FROM OVERNGT WHERE ' +
        'ACNT_NO = A.ACNT_NO AND ARTC_CD = A.ARTC_CD) AS OVERNGT_YN,'
      '                          COUNT(1) OVER() AS TOTCNT, '
      
        '                          (SELECT TOP(1) ARTC_NM FROM ARTC_MST W' +
        'HERE ARTC_CD = A.ARTC_CD) AS ARTC_NM,'
      
        '                          (SELECT TOP(1) DOT_CNT FROM ARTC_MST W' +
        'HERE ARTC_CD = A.ARTC_CD) AS DOT_CNT'
      '                     FROM NCLR_POS A,'
      
        '                          (SELECT A1.* FROM ACNT_MST A1, USER_MS' +
        'T B1 WHERE A1.USER_ID = B1.USER_ID ) B'
    ...
    object dbMainUSER_NM2: TStringField
      FieldName = 'USER_NM'
      Required = True
    end
    object dbMainACNT_NO2: TStringField
      FieldName = 'ACNT_NO'
      ReadOnly = True
      Required = True
      FixedChar = True
    ...
    object dbMainACNT_PWD: TStringField
      FieldName = 'ACNT_PWD'
      ReadOnly = True
      Required = True
      FixedChar = True
    ...
    object dbMainSTK_CD2: TStringField
      FieldName = 'STK_CD'
      ReadOnly = True
      Required = True
      Size = 10
    ...
    object dbMainAVG_PRC: TFloatField
      FieldName = 'AVG_PRC'
      ReadOnly = True
    end
    object dbMainNCNTR_QTY: TIntegerField
      FieldName = 'NCNTR_QTY'
      ReadOnly = True
    end
    ...
    object dbMainNCLR_POS_TM: TStringField
      FieldName = 'NCLR_POS_TM'
      ReadOnly = True
      FixedChar = True
      Size = 12
    end
    ...
    object dbMainOVERNGT_QTY: TIntegerField
      FieldName = 'OVERNGT_QTY'
      ReadOnly = True
    end
    object dbMainOVERNGT_TP: TStringField
      FieldName = 'OVERNGT_TP'
      ReadOnly = True
      FixedChar = True
      Size = 1
    ...
    object dbMainAVGPRC: TStringField
      FieldKind = fkCalculated
      FieldName = 'AVGPRC'
      Size = 30
      Calculated = True
    end
    object dbMainACNT_AMT: TFloatField
      FieldName = 'ACNT_AMT'
      ReadOnly = True
    end
