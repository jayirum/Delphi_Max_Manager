object fmMNG_Notice: TfmMNG_Notice
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = #44288#47532#51088' '#44277#51648#49324#54637
  ClientHeight = 410
  ClientWidth = 798
  Color = clBtnFace
  ...
  object edDate: TkcRzDBEdit
    Left = 8
    Top = 16
    Width = 203
    Height = 20
    TabStop = False
    DataSource = dsMNG_Noti
    DataField = 'MNG_DATE'
    ReadOnly = True
    Color = 15138815
    Ctl3D = True
  ...
  object chView: TbsSkinCheckBox
    ...
    Checked = False
    GroupIndex = 0
    Caption = #45796#49884#48372#51648#50506#51020
    OnClick = chViewClick
  end
  object edSEQ: TkcRzDBEdit
    Left = 264
    Top = 8
    Width = 203
    Height = 20
  ...
  object dbMNG_Noti: TUniQuery
    Connection = MastDB.UniConnection
    SQL.Strings = (
      'select * from MNG_NOTICE')
    AfterInsert = dbMNG_NotiAfterInsert
    Left = 40
    Top = 112
  end
  object dsMNG_Noti: TDataSource
    DataSet = dbMNG_Noti
    Left = 101
    Top = 114
  end
