inherited fmArtc: TfmArtc
  ...
  object RzPanel4: TRzPanel [2]
    ...
    object btnOrdState: TbsSkinSpeedButton
      Tag = 300
      Left = 252
      Top = 348
      Width = 197
    ...
    object bsSkinLabel6: TbsSkinLabel
      ...
      BorderStyle = bvFrame
      Alignment = taCenter
      Caption = 'TICK'#45800#50948'_'#50741#49496'3.0'#48120#47564
      AutoSize = False
    end
    ...
    object bsSkinLabel15: TbsSkinLabel
      ...
      BorderStyle = bvFrame
      Alignment = taCenter
      Caption = 'TICK'#44032#52824'_'#50741#49496'3.0'#48120#47564
      AutoSize = False
    end
    ...
    object bsSkinLabel14: TbsSkinLabel
      ...
      BorderStyle = bvFrame
      Alignment = taCenter
      Caption = #46041#49884#54840#44032#44552#50529
      AutoSize = False
    end
    object bsSkinLabel16: TbsSkinLabel
      ...
      BorderStyle = bvFrame
      Alignment = taCenter
      Caption = #50556#44036')'#53440#51077
      AutoSize = False
    end
    object bsSkinLabel17: TbsSkinLabel
      ...
      BorderStyle = bvFrame
      Alignment = taCenter
      Caption = #50556#44036')'#50984'/'#44552#50529
      AutoSize = False
    end
    ...
    object edTickSizeLow: TkcRzDBEdit
      Left = 138
      Top = 83
      Width = 104
      Height = 20
      DataSource = dsMain
      DataField = 'TICK_SIZE_LOW'
      ReadOnly = True
      FrameController = MastDB.RzFrameController
      ImeName = 'Microsoft IME 2010'
      TabOrder = 26
    ...
    object edTickValueLow: TkcRzDBEdit
      Left = 384
      Top = 83
      Width = 104
      Height = 20
      DataSource = dsMain
      DataField = 'TICK_VALUE_LOW'
      FrameController = MastDB.RzFrameController
      ImeName = 'Microsoft IME 2010'
      TabOrder = 27
      OnChange = edArtcNMChange
    ...
    object cbCmsnTp_Ngt: TkcRzDBComboBox
      Left = 92
      Top = 141
      Width = 150
      Height = 20
      DataField = 'CMSN_TP_NGT'
      DataSource = dsMain
      Style = csDropDownList
      Ctl3D = False
      FrameController = MastDB.RzFrameController
    ...
    object edCmsnAmtrt_Ngt: TkcRzDBEdit
      Left = 338
      Top = 141
      Width = 150
      Height = 20
      DataSource = dsMain
      DataField = 'CMSN_AMTRT_NGT'
      FrameController = MastDB.RzFrameController
      ImeName = 'Microsoft IME 2010'
      TabOrder = 31
      EnterToTab = True
    ...
    object edSamHogaAmt: TkcRzDBEdit
      Left = 92
      Top = 254
      Width = 150
      Height = 20
      DataSource = dsMain
      DataField = 'SAMEHOGA_AMT'
      FrameController = MastDB.RzFrameController
      ImeName = 'Microsoft IME 2010'
      TabOrder = 36
      EnterToTab = True
  ...
  object gdMain: TDBGridEh [3]
    ...
    Columns = <
      ...
      item
        ...
        DynProps = <>
        EditButtons = <>
        FieldName = 'TICKSIZELOW'
        Footers = <>
        Title.Alignment = taCenter
        Title.Caption = 'TICK'#45800#50948'_'#50741#49496'3.0'#48120#47564
        Title.Color = 16250871
        Width = 135
      end
      item
        ...
        DynProps = <>
        EditButtons = <>
        FieldName = 'TICK_VALUE_LOW'
        Footers = <>
        Title.Alignment = taCenter
        Title.Caption = 'TICK'#44032#52824'_'#50741#49496'3.0'#48120#47564
        Title.Color = 16250871
        Width = 135
      end
      item
      ...
      item
        ...
        DynProps = <>
        EditButtons = <>
        FieldName = 'CMSNTP_NGT'
        Footers = <>
        Title.Alignment = taCenter
        Title.Caption = #50556#44036')'#44396#48516
        Title.Color = 16250871
        Width = 90
      end
      item
        ...
        DynProps = <>
        EditButtons = <>
        FieldName = 'CMSN_AMTRT_NGT'
        Footers = <>
        Title.Alignment = taCenter
        Title.Caption = #50556#44036')'#50984'/'#44552#50529
        Title.Color = 16250871
        Width = 85
      end
      item
      ...
      item
        ...
        DynProps = <>
        EditButtons = <>
        FieldName = 'SAMEHOGA_AMT'
        Footers = <>
        Title.Alignment = taCenter
        Title.Caption = #46041#49884#54840#44032#44552#50529
        Title.Color = 16250871
        Width = 80
      end
      item
  ...
  inherited imgBtn: TImageList
    Bitmap = {
      494C01010B007C00900010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  inherited dbMain: TUniQuery
    ...
    object dbMainARTC_NM: TStringField
      FieldName = 'ARTC_NM'
    end
    ...
    object dbMainTICK_SIZE: TFloatField
      FieldName = 'TICK_SIZE'
    end
    object dbMainTICK_SIZE_LOW: TFloatField
      FieldName = 'TICK_SIZE_LOW'
    end
    object dbMainTICK_VALUE: TFloatField
      FieldName = 'TICK_VALUE'
    end
    object dbMainTICK_VALUE_LOW: TFloatField
      FieldName = 'TICK_VALUE_LOW'
    end
    object dbMainTICK_VALUE_USD: TFloatField
      FieldName = 'TICK_VALUE_USD'
    end
    object dbMainARTC_USE_YN: TStringField
      FieldName = 'ARTC_USE_YN'
      FixedChar = True
      Size = 1
    end
    ...
    object dbMainAPI_CLTL: TFloatField
      FieldName = 'API_CLTL'
    end
    object dbMainCMSN_TP: TStringField
      FieldName = 'CMSN_TP'
      FixedChar = True
      Size = 1
    end
    object dbMainCMSN_AMTRT: TFloatField
      FieldName = 'CMSN_AMTRT'
    end
    object dbMainCMSN_AMTRT_USD: TFloatField
      FieldName = 'CMSN_AMTRT_USD'
    end
    object dbMainCMSN_TP_NGT: TStringField
      FieldName = 'CMSN_TP_NGT'
      FixedChar = True
      Size = 1
    end
    object dbMainCMSN_AMTRT_NGT: TFloatField
      FieldName = 'CMSN_AMTRT_NGT'
    end
    ...
    object dbMainOVERNGT_AMT: TFloatField
      FieldName = 'OVERNGT_AMT'
    end
    object dbMainGUJA_CNTR_CNT: TIntegerField
      FieldName = 'GUJA_CNTR_CNT'
    end
    object dbMainLOSSCUT_AMT: TFloatField
      FieldName = 'LOSSCUT_AMT'
    end
    object dbMainMKT_TP: TStringField
      FieldName = 'MKT_TP'
      FixedChar = True
      Size = 1
    end
    object dbMainSTART_TM: TStringField
      FieldName = 'START_TM'
      FixedChar = True
      Size = 4
    end
    object dbMainEND_TM: TStringField
      FieldName = 'END_TM'
      FixedChar = True
      Size = 4
    end
    object dbMainMTR_END_TM: TStringField
      FieldName = 'MTR_END_TM'
      FixedChar = True
      Size = 4
    end
    object dbMainNOTI_1_YN: TStringField
      FieldName = 'NOTI_1_YN'
      FixedChar = True
      Size = 1
    end
    object dbMainNOTI_3_YN: TStringField
      FieldName = 'NOTI_3_YN'
      FixedChar = True
      Size = 1
    end
    object dbMainNOTI_5_YN: TStringField
      FieldName = 'NOTI_5_YN'
      FixedChar = True
      Size = 1
    end
    object dbMainNOTI_10_YN: TStringField
      FieldName = 'NOTI_10_YN'
      FixedChar = True
      Size = 1
    end
    object dbMainMONTH_GAP: TIntegerField
      FieldName = 'MONTH_GAP'
    end
    object dbMainSAMEHOGA_AMT: TFloatField
      FieldName = 'SAMEHOGA_AMT'
    end
    ...
    object dbMainORD_STATE: TStringField
      FieldName = 'ORD_STATE'
      FixedChar = True
      Size = 1
    end
    object dbMainARTC_SORT: TIntegerField
      FieldName = 'ARTC_SORT'
    end
  end
