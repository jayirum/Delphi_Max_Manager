...
type
  TfmNoCntrOrd = class(TfmBasic)
    ...
    btnAllCancel: TbsSkinSpeedButton;
...
procedure TfmNoCntrOrd.btnAllCancelClick(Sender: TObject);
var
	sMsg, sSQL: String;
begin
	with dbMain do
...
procedure TfmNoCntrOrd.btnCancelClick(Sender: TObject);
var
	sMsg, sSQL: String;
begin
	with dbMain do
...
begin
  ...
  begin
    ...
    IntToArr(0,                                TC001.GT_HEADER.ACNT_TP);                   // 1:국내파생, 2:해외파생, 3:국내현물
    ...
    StrToArr(__Local_IP,                       TC001.CLIENT_IP);                           // Client IP
  ...
  MastDB.iwNotiClient.DataToSend := sData + __EOL;
end;
