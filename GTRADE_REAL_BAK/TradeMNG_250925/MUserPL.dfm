inherited fmUserPL: TfmUserPL
  Tag = 3012
  Caption = #54924#50896#51333#47785' '#49552#51061#54788#54889
  ClientWidth = 1133
  KeyPreview = False
  ...
  inherited pnTop: TRzPanel
    ...
    object chCLRPL: TbsSkinCheckBox
      Left = 868
      Top = 3
      Width = 97
      Height = 22
      ...
      Checked = False
      GroupIndex = 0
      Caption = #49552#51061#50668#48512
      OnClick = chCLRPLClick
    end
  end
  inherited pnBottom: TbsSkinPanel
    ...
    object chOp: TbsSkinCheckBox
      ...
      Checked = False
      GroupIndex = 0
      Caption = #44397#45236#50741#49496'('#50556')'
      OnClick = chOpClick
    end
  ...
  object gdMain: TDBGridEh [2]
    ...
    Columns = <
      ...
      item
        ...
        Width = 90
        OnAdvDrawDataCell = gdMainColumns4AdvDrawDataCell
      end
      item
        Color = 16250879
        DynProps = <>
  ...
  inherited imgBtn: TImageList
    ...
    Top = 336
    Bitmap = {
      494C01010B006000880010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
